...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->L3perk->Size = System::Drawing::Size(274, 13);
			this->L3perk->TabIndex = 71;
			this->L3perk->Text = L"ZYSK:   Mariusz Denko dostarcza szeœæ linii kodu wiecej";
			// 
			// L3cost
			// 
			...
			this->L3description->Size = System::Drawing::Size(424, 13);
			this->L3description->TabIndex = 69;
			this->L3description->Text = L"po tym kursie Twój pracownik znacznie poprawi jakoœæ i wydajnoœæ dostarczanego ko"
				L"du";
			// 
			// L3
			// 
